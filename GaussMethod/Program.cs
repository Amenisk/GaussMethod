...
class Program
{
    static void Main()
    {
        try
        {
            Console.WriteLine("Введите коэффициенты двух уравнений через пробел, новое уравнение начинается с новой строки");
    ...
    public static void KramerMethod(double[] firstEq, double[] secondEq)
    {
